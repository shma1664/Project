...
public class ChatRoomServer {
    ...
    public void dealWithSelectionKey(ServerSocketChannel server,SelectionKey sk) throws IOException {
        if(sk.isAcceptable())
        {
            ...
            System.out.println("Server is listening from client :" + sc.socket().getInetAddress());
        ...
        if(sk.isReadable())
        {
            ...
            try
            {
                ...
                System.out.println("Server is listening from client " + sc.socket().getInetAddress() + " data rev is: " + content);
